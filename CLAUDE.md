...
(The giphy self-tool/plugin and its `giphy-modal` type were cut in full — `TASKS/phase-0/15a-cut-giphy.md`. The oembed plugin was cut in full — `TASKS/phase-0/15b-cut-oembed.md`.)
