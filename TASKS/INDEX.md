...
| `adhoc/02-remove-tool-permissions-collapse-to-agent-tools` | not-started | `adhoc/01` (landed — see below; `02`'s own scope narrowed, `requireRealAgentToolsTarget` was already removed by `01`) |
