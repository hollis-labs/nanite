...
| `10/04` | `10-architectural-concentration/04-chatserviceimpl-generateresponse-action-pipeline.md` | reviewed | `10/01` | AD-12 (decided) |
| `10/05` | `10-architectural-concentration/05-selftoolstransport-selective-delegation.md` | reviewed | `10/02` | AD-13 (decided) |
...
| Task | File | Status | Depends on | Gated on |
|---|---|---|---|---|
| `14/01` | `14-followups/01-remove-default-seeded-catalog-source.md` | reviewed | `01/01` (landed) | AD-05 (decided) |
...
| `13/04` | `13-mechanical-cleanup/04-low-risk-error-handling-batch.md` | implemented | Wave 7 complete | — |
