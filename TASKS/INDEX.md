...
| Task | Status | Depends on |
|---|---|---|
| 01-rebuild-todo-list-as-composition | validated | none |
| 02-rebuild-plan-review-as-composition | validated | none |
| 03-rebuild-subagent-spawn-approval-as-composition | validated | none |
| 04-build-interactive-table-row-actions-primitive | validated | none |
| 05-exclude-card-data-from-replayed-context | validated | none |
