...
| 08-kill-file-reingest-on-boot-pattern | implemented | `TASKS/phase-0/10-seed-builtin-agent-profiles` (implemented); `01` (roles negative-verification) |
...
| 12-fix-agent-service-get-drops-new-db-only-columns | not-started | `02`, `03` (the columns whose reads this task fixes) |
