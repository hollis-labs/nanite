Run the blg skill to quick-capture a backlog item to Engine. Takes an argument describing the idea or future work.
...
2. Creates the backlog item via mcp__engine__engine_backlog_capture
