...
1. Validates project is known (engine, conduit, vanta-conduit, hadron, nexus, mentat, cerberus, carrier, nanite, sigil, suds-v2, lnklst, _shared)
...
4. Writes to Cortex via mcp__cortex__context_typed_write with namespace={project}/docs, status=draft
