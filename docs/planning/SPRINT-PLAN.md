# CONDUIT — Sprint Plan (Historical)

**Date:** 2026-03-07 (original), 2026-03-15 (rebranded)
**Status:** Historical — these sprints are complete. See Volon for current sprints.
...
### Tasks
- S0-01: Initialize Go module, cmd/conduit entry point
...
**Exit criteria:** `go run ./cmd/conduit` serves the 4-column layout on localhost:8090 with panel toggles working.
