...
register under their own server names (`oembed`, `support-ticket`). No
cross-cutting plugin renames required. (The `giphy` plugin registration was cut
in full — `TASKS/phase-0/15a-cut-giphy.md`.)
