...
type: note
title: Loom
description: '# Loom  Loom content generation and wiki compiler  A **Sysop UI** application: a React frontend built on [`@hollis-labs/sysop-ui`](https://github.com/hollis-labs/sysop-ui) served b...'
status: active
sources:
    - README.md
---
