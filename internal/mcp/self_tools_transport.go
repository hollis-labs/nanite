...
func (st *SelfToolsTransport) callRunReport(args map[string]any) (*ToolResult, error) {
	...
	if content == "" {
		// Demo simulation: generate a placeholder report.
		content = fmt.Sprintf(`<h1>%s Report</h1>
<p>Generated at %s</p>
<h2>Overview</h2>
<p>This is a simulated report for demonstration purposes. In production, this would be generated by Hadron blueprint execution.</p>
<h2>Key Metrics</h2>
<ul>
<li>Tasks completed: 12/18 (67%%)</li>
<li>Sprint velocity: 34 points</li>
<li>Blocked items: 2</li>
<li>Code coverage: 78%%</li>
</ul>
<h2>Summary</h2>
<p>The portfolio is on track. Two blocked items require attention from the platform team.</p>`,
