...
func workflowExecuteLLMStepToolDefinition() Tool {
	return Tool{
...
func workflowExecuteToolStepToolDefinition() Tool {
	return Tool{
...
func workflowVerifyStepToolDefinition() Tool {
	return Tool{
...
func (st *SelfToolsTransport) callWorkflowExecuteLLMStep(ctx context.Context, args map[string]any) (*ToolResult, error) {
...
func (st *SelfToolsTransport) callWorkflowExecuteToolStep(ctx context.Context, args map[string]any) (*ToolResult, error) {
	if st.WorkflowExecutor == nil {
		return errorResult("workflow executor is not configured"), nil
	}
...
func (st *SelfToolsTransport) callWorkflowVerifyStep(ctx context.Context, args map[string]any) (*ToolResult, error) {
	...
	if req.Mode == "" {
		return errorResult("mode is required (engine|agent)"), nil
	}
