...
Use kind="envelope" with a registered type for display cards (giphy-modal, report-card, metric-card, etc.). Use kind="question"/"action"/"approval" for interactive forms and proposals.
