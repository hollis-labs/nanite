...
//
// CW-20260429-0029 (c114 follow-up): nanite_tool_describe's 6813-byte
...
// before nanite_show_card, and the agent burned all 10 turns shuffling
// pointers instead of emitting an envelope.
//
// Exempted tools:
//   - nanite_tool_describe — discovery contract; agent must read inline.
//   - nanite_validate     — pre-flight validator; structured findings the
