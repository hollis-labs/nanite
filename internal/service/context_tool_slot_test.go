...
func TestAssembleSlots_S3b_RulesHitHydrates(t *testing.T) {
	...
	r, err := svc.AssembleSlots(context.Background(), sess, agent, &store.AgentMode{}, nil, tools3(), "", 200000)
	if err != nil {
...
func TestAssembleSlots_S3b_SelectionHashRebuild(t *testing.T) {
	...
	reduced := tools3()[:2]
	second, err := svc.AssembleSlots(context.Background(), sess, agent, &store.AgentMode{}, nil, reduced, "", 200000)
	if err != nil {
...
func TestAssembleSlots_S3b_StateTransitionTracking(t *testing.T) {
	...
	first, _ := svc.AssembleSlots(context.Background(), sess, agent, &store.AgentMode{}, nil, tools3(), "", 200000)
	...
	second, _ := svc.AssembleSlots(context.Background(), sess, agent, &store.AgentMode{}, nil, tools3(), "", 200000)
