...
// Phase 0 item 21 ("Cut Modes, in full") deleted ModeAutoSwitchPref (B3,
// CW-20260428-0011) along with the rest of Session Mode — the per-session
// auto-mode-switch preference had no real behavior left once the
// mode_suggestion SSE event (classify.ClassifyMode) and
// sessions.current_mode_id were both cut. The three tests that used to
// cover its default / round-trip / validation behavior were removed with
// it.
