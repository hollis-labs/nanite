 ...
 *
 * Reads JSON Schema files from internal/envelope/schemas/ and generates
 ...
 *   node scripts/generate-envelope-types.mjs --check  (staleness check, exits 1 if stale)
 */
...
const SCHEMA_DIR = join(ROOT, 'internal', 'envelope', 'schemas');
...
function generate(schemas) {
  ...
  lines.push('// Generated by scripts/generate-envelope-types.mjs from internal/envelope/schemas/');
  lines.push('// To regenerate: node scripts/generate-envelope-types.mjs');
  lines.push('');
