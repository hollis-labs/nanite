  ...
  return (
    <Card>
      <div className="p-5 space-y-5">
        ...
        {/* Can Execute toggle */}
        <div
          className="flex items-center justify-between px-3 py-2.5 rounded-lg bg-bg-elevated/60 border border-border-subtle cursor-pointer hover:bg-surface/40 transition-colors"
