      ...
      <div className="flex flex-col gap-1.5">
            ...
            {toolInput > 0 && (
              <>
                <WidgetRow label="  Content">
                  <span className="font-mono text-[11px] text-info opacity-85">
                    {formatTokens(contentInput)}
                  </span>
                </WidgetRow>
                <WidgetRow label="  Tools">
                  <span className="font-mono text-[11px] text-primary">
                    {formatTokens(toolInput)}
                  </span>
                </WidgetRow>
              </>
            )}
        ...
        {globalTotal > 0 && (
          <div className="pt-2 mt-0.5 border-t border-divider">
            ...
            <WidgetRow label="All sessions" mono>
